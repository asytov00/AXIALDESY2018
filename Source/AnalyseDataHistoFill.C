...
if(flagpos) hxy2P->Fill(x2,y2); 
if(flagpos) hthXYinP->Fill(thXin,thYin);
...
if(flagpos) CradthYin2018Ph_gamma->Fill((float)h2st+thYin,calo_crys_tot_energy_gamma);
...
if(flagpos) ScinP->Fill(scin);
if(flagpos) hthXinScinP->Fill(thXin,scin);
if(flagpos) hthYinScinP->Fill(thYin,scin);

if(flagpos) hRotScin_pinP->Fill((float)h2st+divcorr,scin);          
if(flagpos) hRotScin_minP->Fill((float)h2st-divcorr,scin);

if(flagpos) hCradScin_pinP->Fill((float)h2st+thYin,scin); 
...
if(flagpos) hPhotomP->Fill(photom);
if(flagpos) hthXinPhotomP->Fill(thXin,photom);
if(flagpos) hthYinPhotomP->Fill(thYin,photom);

if(flagpos) hRotPhotom_pinP->Fill((float)h2st+divcorr,photom);          
if(flagpos) hRotPhotom_minP->Fill((float)h2st-divcorr,photom);

if(flagpos) hCradPhotom_pinP->Fill((float)h2st+thYin,photom);          
if(flagpos) hCradPhotom_minP->Fill((float)h2st-thYin,photom);


if(flagpos) hCradPhotomP->Fill((float)h2st,photom); 
if(flagpos) hRotPhotomP->Fill((float)h2st,photom);
